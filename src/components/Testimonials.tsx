...
const testimonials = [
  {
    ...
    result: '2.4x ROAS',
    text: "Ahmed completely transformed our Facebook advertising. In 4 months, we went from a struggling 0.8x ROAS to a solid 2.4x. He's a true growth partner who understands business, not just ads.",
    color: '#00f5ff',
  },
  {
    name: 'Mark D.',
    ...
    rating: 5,
    platform: 'Google Ads',
    result: '-30% Cost Per Lead',
    text: "We'd been burning budget on Google Ads for months. Ahmed restructured everything — our CPL dropped from $120 to $45 and the leads actually converted.",
    color: '#bf00ff',
  },
  {
    name: 'Layla M.',
    ...
    result: '$15K in Month 3',
    text: "We launched our brand from zero with Ahmed's help. The TikTok + Facebook strategy was highly effective — we hit $15K in revenue in month 3 with a 2.5x ROAS.",
    color: '#39ff14',
  },
  {
    name: 'Omar A.',
    ...
    result: '+150% Enrollments',
    text: "Ahmed grew our course enrollments from 20 to 50 per month. What impressed me most was his understanding of the Arabic market nuances — something most marketers miss entirely.",
    color: '#00f5ff',
  },
  {
    name: 'Nour R.',
    ...
    text: "Before working with Ahmed, we relied entirely on referrals. Now we get 40+ qualified leads every month at $4.50 per lead. The funnel he built pre-qualifies everyone.",
    color: '#bf00ff',
  },
  {
    name: 'Karim S.',
    ...
    result: '+120% Online Orders',
    text: "I was skeptical that social media ads could really drive restaurant sales. Ahmed proved me wrong — we went from 15 online orders to 35 per month using geo-specific campaigns.",
    color: '#39ff14',
  },
];
  ...
  return (
    <div className="flex gap-0.5">
      {Array.from({ length: 5 }).map((_, i) => (
        <svg key={i} className={`w-4 h-4 ${i < rating ? 'text-yellow-400' : 'text-text-muted'}`} fill="currentColor" viewBox="0 0 20 20">
...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="relative py-24 overflow-hidden bg-bg-base">
      {/* Background */}
      ...
      <div className="relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8">
            {[
              ...
              <div key={badge.label} className="flex items-center gap-2">
                ...
                <span className="font-bold text-text-base">{badge.value}</span>
        ...
        >
          {/* Fade edges */}
          <div className="absolute left-0 top-0 bottom-0 w-32 z-10 bg-gradient-to-r from-bg-base to-transparent pointer-events-none"></div>
          <div className="absolute right-0 top-0 bottom-0 w-32 z-10 bg-gradient-to-l from-bg-base to-transparent pointer-events-none"></div>
              ...
              >
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-text-base font-semibold">{t.name}</div>
                ...
                <p className="text-text-muted text-sm leading-relaxed">"{t.text}"</p>

                <div className="flex items-center gap-2 text-xs text-text-muted border-t border-white/5 pt-3">
                  <span>📱</span>
        ...
        <div className="text-center mt-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 reveal">
          <p className="text-text-muted mb-4">Ready to join the list of satisfied clients?</p>
          <button
